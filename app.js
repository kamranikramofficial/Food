  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    if (currentUser) {
      try {
        ...
        if (authLinks) {
          authLinks.innerHTML = `
                      <span>Welcome, <strong>${userData.name || userData.email}</strong></span>
          ...
          if (logoutBtn) {
            logoutBtn.addEventListener("click", (e) => {
              ...
              window.location.href = "singin page/index.html"
            })
          }
        }
      } catch (error) {
          ...
          <div id="recipe-modal" class="modal">
              <div class="modal-content">
                  ...
                  <div class="modal-image">
                      <img id="modal-image" src="/placeholder.svg" alt="Recipe Image">
                  </div>
                  <div class="modal-details">
                      <p><strong>Cuisine:</strong> <span id="modal-cuisine"></span></p>
                      <p><strong>Prep Time:</strong> <span id="modal-prep-time"></span> min</p>
                      <p><strong>Cook Time:</strong> <span id="modal-cook-time"></span> min</p>
                      <p><strong>Difficulty:</strong> <span id="modal-difficulty"></span></p>
                      <p><strong>Calories:</strong> <span id="modal-calories"></span> per serving</p>
                  </div>
    ...
    function showRecipeDetails(recipe) {
      ...
      document.getElementById("modal-prep-time").textContent = recipe.prepTimeMinutes
      document.getElementById("modal-cook-time").textContent = recipe.cookTimeMinutes
      document.getElementById("modal-difficulty").textContent = recipe.difficulty
      document.getElementById("modal-calories").textContent = recipe.caloriesPerServing
        let ingredientsList = document.getElementById("modal-ingredients-list")
      ...
      let instructionsList = document.getElementById("modal-instructions-list")
