...
for (let i = 0; i < recipes.length; i++) {
    ...
    <div class="recipe-card">
        ...
        <div class="recipe-info" >
            ...
            <p>Prep Time: ${recipes[i].prepTimeMinutes} minutes</p>
            <div class="rating">
            <p>Rating: ${recipes[i].rating} <i class="fas fa-star"> </i> (${recipes[i].reviewCount} reviews)</p>
            </div >
            <div class="meal-type">
            <p>Meal Type: ${recipes[i].mealType.join(", ")}</p>
            </div>
        </div > `
        ...
        main.addEventListener('click', function() {
            alert(
                ...
                `Prep Time: ${recipes[i].prepTimeMinutes} min\n` +
                `Cook Time: ${recipes[i].cookTimeMinutes} min\n` +
                `Difficulty: ${recipes[i].difficulty}\n` +
                `Calories: ${recipes[i].caloriesPerServing} per serving\n\n` +
                `Ingredients:\n- ${recipes[i].ingredients.join("\n- ")}\n\n` +
                `Instructions:\n- ${recipes[i].instructions.join("\n- ")}`
            );
        });
